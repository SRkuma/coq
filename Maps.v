...
Proof.
  ...
  intros.
  unfold t_update.
  destruct (beq_id x x0);reflexivity.
Qed.
(** [] *)
...
Proof.
  intros.
  remember (beq_id x y) as b.
  destruct b;symmetry in Heqb.
  - apply beq_id_true_iff in Heqb;constructor;auto.
  - apply beq_id_false_iff in Heqb;constructor;auto.
Qed.
(** [] *)
...
Proof.
  ...
  intros.
  unfold t_update.
  destruct (beq_idP x x0);subst;auto.
Qed.                           
(** [] *)
...
Proof.
  ...
  intros.
  unfold t_update.
  destruct (beq_idP x1 x);destruct (beq_idP x2 x);(try reflexivity).
  subst. contradiction.
Qed.
(** [] *)
