...
Proof. unfold nandb;simpl;auto. Qed.
...
Proof. unfold andb3. simpl;auto. Qed.
...
Example test_leb1:             (ble_nat 2 2) = true.
Proof. simpl. reflexivity.  Qed.
Example test_leb2:             (ble_nat 2 4) = true.
Proof. simpl. reflexivity.  Qed.
Example test_leb3:             (ble_nat 4 2) = false.
Proof. simpl. reflexivity.  Qed.
...
Proof. unfold blt_nat. simpl;auto. Qed.
...
Proof.
  induction n;auto.
Qed.
Lemma beq_nat_true : forall n m, beq_nat n m = true -> n = m.
Proof.
  intro. induction n;intros.
  - symmetry. apply beq_nat_0_l. auto.
  - destruct m.
    + simpl in H. inversion H.
    + simpl in H. apply IHn in H;auto.
Qed.
